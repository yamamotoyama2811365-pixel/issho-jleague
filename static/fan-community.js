(() => {
  ...
  const ownKey='sapporo-own-cheers-v1';let own=[];try {own=JSON.parse(localStorage.getItem(ownKey)||'[]');if(!Array.isArray(own))own=[];} catch (_) {}
